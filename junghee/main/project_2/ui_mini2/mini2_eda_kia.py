...
def load_data():
    ...
    df_export = pd.read_csv(os.path.join(BASE_DIR, "data_mini2/기아_지역별수출실적_전처리.csv"))
    ...
    # 차종별 판매 데이터
    df_sales = pd.read_csv(os.path.join(BASE_DIR, "data_mini2/기아_차종별판매실적.csv"))
    ...
    # 해외공장 판매 데이터
    df_factory = pd.read_csv(os.path.join(BASE_DIR, "data_mini2/기아_해외공장판매실적_전처리.csv"))
    ...
    # 해외현지판매 데이터
    df_overseas = pd.read_csv(os.path.join(BASE_DIR, "data_mini2/기아_해외현지판매_전처리.csv"))
    ...
    df_export2 = pd.read_csv(os.path.join(BASE_DIR, "data_mini2/기아_지역별수출실적_전처리.csv"))
