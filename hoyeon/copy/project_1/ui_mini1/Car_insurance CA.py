...
# Insurance company and model data definitions for Canada
launch_dates = {
    'Hyundai': {
        'G70 (IK)': '2017-09',
        'NEXO (FE)': '2018-01',
...
# Cluster-based insurance recommendations (Intact + 1 other insurer)
insurance_recommendations = {
    0: ["Intact", "Desjardins"],
    1: ["Intact", "TD Insurance"],
    2: ["Intact", "Aviva"],
    3: ["Intact", "RSA"],
    4: ["Intact", "Belairdirect"],
    5: ["Intact", "The Co-operators"]
}

# Insurance company details (Canadian version)
insurance_companies = {
    "Intact": {
        "logo": "hoyeon/hun_bo.png",
        "description": "Canada's largest P&C insurer with nationwide coverage and MyAuto program",
        "strengths": ["Hyundai partner discounts", "Accident forgiveness", "24/7 claims service"],
        "contact": "1-866-464-2424",
        "discounts": {
            "eco": 0.15,
            "no_accidents": 0.1,
            "new_car": 0.05
        ...
        "coverage_details": {
            "Basic Coverage": ["Third-party liability: $2M", "Accident benefits", "Direct compensation"],
            "Special Coverage": ["OEM parts guarantee", "Waiver of depreciation", "Rental car coverage"],
            "Discounts": ["Multi-policy discount", "Claims-free discount", "Winter tire discount"]
        }
    },
    "Desjardins": {
        "logo": "hoyeon/sam_bo.png",
        "description": "Quebec-based insurer with strong national presence and Ajusto program",
        "strengths": ["Usage-based insurance", "Hybrid/Electric discounts", "Bilingual service"],
        "contact": "1-877-699-6848",
        "discounts": {
            "eco": 0.1,
            "no_accidents": 0.15,
            "new_car": 0.03
        ...
        "coverage_details": {
            "Basic Coverage": ["Third-party liability: $2M", "Accident benefits", "Uninsured auto"],
            "Special Coverage": ["EV charging equipment", "Roadside assistance", "Waiver of deductible"],
            "Discounts": ["Ajusto telematics discount", "Multi-vehicle discount", "Alumni discounts"]
        }
    },
    "TD Insurance": {
        "logo": "hoyeon/kb_bo.png",
        "description": "Major bank-owned insurer with competitive rates and MyAdvantage program",
        "strengths": ["Bank customer discounts", "Online management tools", "Hyundai specific packages"],
        "contact": "1-877-777-7136",
        "discounts": {
            "eco": 0.12,
            "no_accidents": 0.12,
            "new_car": 0.04
        ...
        "coverage_details": {
            ...
            "Discounts": ["MyAdvantage usage discount", "Multi-product discount", "Group discounts"]
        }
    },
    "Aviva": {
        "logo": "hoyeon/db_bo.png",
        "description": "Global insurer with strong Canadian presence and Aviva Drive program",
        "strengths": ["DrivePlus rewards", "Hyundai certified repairs", "Family protection"],
        "contact": "1-866-692-8482",
        "discounts": {
            "eco": 0.13,
            "no_accidents": 0.13,
            "new_car": 0.05
        ...
        "coverage_details": {
            ...
            "Discounts": ["DrivePlus safe driving", "Multi-vehicle discount", "Homeowner discount"]
        }
    },
    "RSA": {
        "logo": "hoyeon/han_bo.png",
        "description": "Royal & Sun Alliance offering specialized coverage options across Canada",
        "strengths": ["Flexible payment options", "Hyundai dealer partnerships", "Bilingual claims"],
        "contact": "1-800-463-6586",
        "discounts": {
            "eco": 0.1,
            "no_accidents": 0.1,
            "new_car": 0.05
        ...
        "coverage_details": {
            "Basic Coverage": ["Third-party liability: $2M", "Accident benefits", "Direct compensation"],
            "Special Coverage": ["Waiver of depreciation", "Transportation replacement", "Key fob replacement"],
            "Discounts": ["Claims-free discount", "Professional association discounts", "Winter tire discount"]
        }
    },
    "Belairdirect": {
        "logo": "hoyeon/mer_bo.png",
        "description": "Direct insurer with innovative coverage options and Ajusto program",
        "strengths": ["Quick online quotes", "Usage-based discounts", "24/7 claims service"],
        "contact": "1-888-280-9111",
        "discounts": {
            "eco": 0.15,
            "no_accidents": 0.15,
            "new_car": 0.07
        ...
        "coverage_details": {
            "Basic Coverage": ["Third-party liability: $2M", "Accident benefits", "Uninsured auto"],
            "Special Coverage": ["New car replacement", "Roadside assistance", "Waiver of deductible"],
            "Discounts": ["Ajusto telematics discount", "Multi-policy discount", "Alarm system discount"]
        }
    },
    "The Co-operators": {
        "logo": "hoyeon/lot_bo.png",
        "description": "Canadian co-operative insurer with community-focused values",
        "strengths": ["Member dividends", "Eco-friendly discounts", "Community support"],
        "contact": "1-877-795-7276",
        "discounts": {
            "eco": 0.1,
            "no_accidents": 0.1,
            "new_car": 0.05
        ...
        "coverage_details": {
            "Basic Coverage": ["Third-party liability: $2M", "Accident benefits", "Direct compensation"],
            "Special Coverage": ["EV charging equipment", "Depreciation waiver", "Trip interruption"],
            "Discounts": ["Multi-policy discount", "Claims-free discount", "Green vehicle discount"]
        }
    }
}

# Insurance type details (Canadian version)
insurance_type_details = {
    "Eco-Friendly Plus": {
        "description": "Special coverage for hybrid/electric vehicles with Canadian-specific protections",
    ...
    "Premium Protection": {
        "description": "Comprehensive coverage with premium benefits for luxury vehicles",
        "price_range": "$200-$350/month",
        "base_price": 275,
        "coverages": {
            "Mandatory Coverage": [
                "Third-party liability: $2M",
    ...
    "Standard Protection": {
        "description": "Basic auto insurance meeting provincial requirements",
...
def input_customer_info():
    ...
    st.title("📋 Hyundai Canada Customer Information")
    ...
    with st.form(key="customer_form"):
        ...
        with col1:
            transaction_amount = st.number_input("Budget (CAD)", min_value=10000, step=1000, format="%d", key="budget")
...
def Car_insurance_recommendation():
    ...
    st.title("🚗 Personalized Hyundai Canada Auto Insurance")
    ...
    with st.container():
        st.write("")
        st.write("")
        st.subheader("🏆 Recommended Canadian Insurers")
        st.write("")
        
        recommended_insurances = insurance_recommendations.get(cluster_id, ["Intact"])
        ...
        for idx, insurance in enumerate(recommended_insurances):
            with cols[idx]:
                ...
                with st.container():
                    ...
                    if insurance == "Intact":
                        st.markdown('<div class="highlight" style="font-size: 0.9rem;">✅ Preferred Hyundai Canada partner discounts</div>', unsafe_allow_html=True)
    ...
    with st.container():
        ...
        def calculate_insurance_price(base_price):
            # Canadian-specific rating factors
            factors = {
                "driving_exp": {
                    "Under 1 year": 1.5, 
                    "1-3 years": 1.2, 
        ...
        for ins in recommended_insurances:
            ...
            # Apply Canadian-specific discounts
        ...
        <div class="highlight">
            ...
            <p style='font-size: 1.5rem; font-weight: bold; margin: 0.5rem 0;'>
                ${min_price:,} - ${max_price:,} CAD
            </p>
            <p style='font-size: 0.9rem; margin: 0;'>* Based on your profile and provincial requirements. Final premium subject to insurer approval.</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        for ins, price in insurance_prices.items():
            with st.expander(f"{ins} - Estimated Monthly Premium: ${price:,} CAD", expanded=True):
