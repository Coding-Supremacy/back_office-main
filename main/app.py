...
def main():
        ...
        if dashboard_type == "👤 딜러 전용 대시보드":
            ...
            if brand == "기아":
                analysis_menu = option_menu(
                    menu_title="분석 메뉴",
                    options=["🏠 홈", "📍 지역별 예측", "🌦️ 기아 기후별 예측","🌎글로벌 고객 데이터 분석", "🚗 기아 22년~25년 수출 분석", "📈 시장 트렌드", "🧑‍💻개발과정"],
                ...
                analysis_menu = option_menu(
                    menu_title="분석 메뉴",
                    options=["🏠 홈", "📍 지역별 예측", "🌦️ 현대 기후별 예측","🌎글로벌 고객 데이터 분석", "🚙 현대 22년~25년 수출 분석", "📈 시장 트렌드", "🧑‍💻개발과정"],
    ...
    if st.session_state["dashboard_type"] == "👤 딜러 전용 대시보드":
        ...
        if analysis_menu == "🏠 홈":
            ...
            run_all_eda()
        elif analysis_menu in ["🚗 기아 22년~25년 수출 분석", "🚙 현대 22년~25년 수출 분석"]:
            # 분석 모듈 선택
            if st.session_state["brand"] == "기아":
                run_eda_kia()
            elif st.session_state["brand"] == "현대":
